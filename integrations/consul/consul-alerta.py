...
def createalert( data ):
    ...
    alert = Alert(resource=data['Node'], event=data['Status'], environment=environment, service=[data['CheckId']], severity=SEVERITY_MAP[data['Status']], text=data['Output'], timeout=timeout, origin=origin, type=alerttype)
